...
| Update manifest signature covered a pipe-delimited string, which is ambiguous if a field contains `|`. | `a_updater.canonical_manifest_payload` | Signs/verifies canonical, sorted-key JSON bytes instead. |
